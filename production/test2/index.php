	   ...
	   <table class="tbl-qa">
		  <thead>
			  <tr>
				...
				<th class="table-header">primero</th>
				<th class="table-header">segundo</th>
			  </tr>
		  </thead>
		  <tbody>
		  <?php
		  ...
		  ?>
			  <tr class="table-row">
				<td><?php echo $k+1; ?></td>
				<td contenteditable="true" onBlur="saveToDatabase(this,'fisrt','<?php echo $faq[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $faq[$k]["fisrt"]; ?></td>
