...
/*$sql="SELECT * from usuarionom WHERE $id=us_login and gafete='B'";
$query_user=sqlsrv_query($conn,$sql);  //se ingresa el grupo al que pertenece
...
echo '<br><center>Error, el periodo en datosp ya existe y es:</center>';
