...
<div>
              ...
              <!--table id="myTable" class="table table-striped table-bordered"-->
                            <thead>
                              <tr>
      <th class="text-center"><font  size="2">Numero Empleado</font></th>
      <th style="min-width:100px"><font  size="2">Nombre</font></th>
    
      <th><font  size="2">Periodo</font></th>
      <th class="text-center"><font  size="2">Cheque</font></th>
      <th class="text-center"><font  size="2">Transferencia</font></th>
      <th class="text-center"><font  size="2">Dias Trabajados</font></th>
      <th class="text-center"><font  size="2">Dias de Descanso</font></th>
      <th class="text-center"><font  size="2">Dias Adicionales</font></th>
      <th class="text-center"><font  size="2">Dias Descanso Adicionales</font></th>
	  <th class="text-center"><font  size="2">Dias Vacaciones</font></th>
      <th class="text-center"><font  size="2">Dias Totales</font></th>
      <th class="text-center"><font  size="2">Sueldo Diario</font></th>
      <th class="text-center"><font  size="2">Total Sueldo D</font></th>
      <th class="text-center"><font  size="2">Pasaje Dirario</font></th>
      <th class="text-center"><font  size="2">Total Pasaje</font></th>
      <th class="text-center"><font  size="2">Total Incentivo</font></th>
	   <th class="text-center"><font  size="2">Total Incent.Permanencia</font></th>
      <th class="text-center"><font  size="2">Total Percepciones</font></th>
...
$suma_cahorro+=$cahorro;
    ?>
                              <tr>
<td class="text-center"><font size="2"><?php echo $NoEmpleado; ?></font></td>
<td style="min-width:100px"><font size="2"><?php echo $us_nombre_real; ?></font></td>  
<td><font size="2"><?php echo $periodo_fecha; ?></font></td>           
<td class="text-center"><font size="2"><?php echo $cheque; ?></font></td>                  
<td class="text-center"><font size="2"><?php echo $transferencia; ?></font></td>  
<?php /*<td>$<?php echo number_format($cahorro, 2, ".", ","); ?></td>    */ ?>
<?php /*<td>$<?php echo number_format($infonavit, 2, ".", ","); ?></td>  */ ?>
<td class="text-center"><font size="2"><?php echo $dias_trabajados; ?></font></td>         
<td class="text-center"><font size="2"><?php echo number_format($dias_descanso, 2, ".", ","); ?></font></td>           
<td class="text-center"><font size="2"><?php echo $dias_adicionales; ?></font></td>   
<td class="text-center"><font size="2"><?php echo number_format($totales_adicionales, 2, ".", ","); ?></font></td>    
<td class="text-center"><font size="2"><?php echo number_format($totales_dvac, 2, ".", ","); ?></font></td>     
<td class="text-center"><font size="2"><?php echo number_format($toatels_trabajados, 2, ".", ","); ?></font></td>      
<td class="text-center"><font size="2">$<?php echo number_format($sueldos, 2, ".", ","); ?></font></td>                  
<td class="text-center"><font size="2">$<?php echo number_format($totales_trabj_sueld, 2, ".", ","); ?></font></td>      
<td class="text-center"><font size="2">$<?php echo number_format($pasajes, 2, ".", ","); ?></font></td>                  
<td class="text-center"><font size="2">$<?php echo number_format($pasaje_total, 2, ".", ","); ?></font></td>             
<td class="text-center"><font size="2">$<?php echo number_format($incentivo, 2, ".", ","); ?></font></td> 
<td class="text-center"><font size="2">$<?php echo number_format($incentivosp, 2, ".", ","); ?></font></td>                
<td class="text-center"><font size="2">$<?php echo number_format($total_suma_final, 2, ".", ","); ?></font></td>         
...
<?php /*   <td>$<?php echo number_format($suma_infonavit, 2, ".", ","); ?></td> */ ?> 
   ...
   <td></td> 
   <td></td>    
   <td class="text-center"><?php echo number_format($suma_totales_adicionales, 2, ".", ","); ?></td>     
   <td class="text-center"><?php echo number_format($suma_totales_dvac, 2, ".", ","); ?></td>   
   <td class="text-center"><?php echo number_format($suma_toatels_trabajados, 2, ".", ","); ?></td>      
   <td class="text-center">$<?php echo number_format($suma_sueldos, 2, ".", ","); ?></td>                 
   <td class="text-center">$<?php echo number_format($suma_totales_trabj_sueld, 2, ".", ","); ?></td>     
   <td class="text-center">$<?php echo number_format($pasajes_suma, 2, ".", ","); ?></td>        
   <td class="text-center">$<?php echo number_format($suma_pasaje_total, 2, ".", ","); ?></td>   
   <td class="text-center">$<?php echo number_format($suma_incentivo, 2, ".", ","); ?></td>   
   <td class="text-center">$<?php echo number_format($suma_incentivop, 2, ".", ","); ?></td> 
   <td class="text-center">$<?php echo number_format($suma_de_todo, 2, ".", ","); ?></td>
   </tr>                            
                          </table>
                      </div><!--- style="width:1700px;  overflow:auto --->
                        </div>
